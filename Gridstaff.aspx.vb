...
Partial Class Gridstaff
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        Dim cmd As New SqlCommand("select sname,Gender,DOB,Mobilenumber,Emergencynumber,Emailid,Accountnumber,Addarnumber,Branch from instaff where Staffid='" & TextBox1.Text & "'", cn)
        cn.Open()
